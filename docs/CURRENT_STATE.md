...
- Поточна версія застосунку: `0.21.1`.
- Останній підтверджений production-код: commit `c3885cd9e9258840cf46dbb440ca24ed724fe098`; інтеграційна частина SignalSynch — commit `1027f1737b63561dbaf28ce54a6965dee473c7b3`. `laba-portal.service`, `koro-signal-sheets-sync.service` і Caddy активні, `/healthz` відповідає, `PRAGMA quick_check` повертає `ok`, а production-тести LABA проходять `9/9`.
