...
- Останній підтверджений production-код: commit `118399f6aa06b2887f756c19adc34744acf387fd`; `laba-portal.service` активний, `/healthz` відповідає, `PRAGMA quick_check` повертає `ok`.
