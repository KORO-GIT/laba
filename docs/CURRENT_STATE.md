...
- Поточна версія застосунку: `0.22.0`.
- Останній підтверджений production-код: commit `983b7ebaf563de36519ddfa0a6efc78b7aa7f109`; інтеграційна частина SignalSynch — commit `8f81ae22bb2e428de89b608d26e6adf7aebe63f3`. `laba-portal.service`, `koro-signal-sheets-sync.service` і Caddy активні, `/healthz` відповідає, `PRAGMA quick_check` повертає `ok`, а production-тести LABA проходять `9/9`. Стартова й наступна інтервальна синхронізації передали по 221 запису без помилок і незавершених outbox-дій.
