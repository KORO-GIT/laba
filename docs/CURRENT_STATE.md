...
- Start **2026-09-11 12:34:56 UTC**, NRestarts0, health200; без JWT Service/ERP API401, SQLite/FK/write-path ok, root750/env640/data700/DB660. `.env`, Caddy hash та час запуску всіх сусідніх служб незмінні. SignalSynch працює без змін коду/конфігурації; очікується штатний наступний snapshot, жодного ручного запису таблиць не запускали.
