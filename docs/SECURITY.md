...
- Користувацькі рядки потрапляють у DOM через `textContent`, не HTML. ERP не додає upload, виконання shell, довільних URL чи зовнішніх CDN. CSP/anti-indexing успадковані від порталу.
