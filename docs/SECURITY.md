...
- `/erp` та `/api/erp/*` вимагають активного користувача LABA й окрему ERP-роль. Права перевіряються на сервері при кожному запиті; майстер отримує лише власну чергу та власні зміни. Роль ERP не відкриває пристрої, існуючі дошки чи глобальну адмінку.
