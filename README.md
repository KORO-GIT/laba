...
- редактор канбан-дошок: назви, кольори й порядок колонок, проміжні етапи, вхідні статуси `Обліку`, кінцеві статуси, кастомні кольорові статуси карток та права користувачів;
